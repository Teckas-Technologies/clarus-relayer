...
const relayerMnemonic = "present close enlist jazz sting bread denial anxiety often scheme window frozen";
...
// Substrate wss url
const node_url = 'ws://127.0.0.1:9944'; //'ws://165.22.190.180:9944';
// MongoDb Url
